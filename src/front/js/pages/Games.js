...
const Games = () => {
	return (
		...
		/*
		<div className="games_bg min-vh-100">
			<Container className="h-100" style={{ paddingTop: 100 }}>
				<Row>
					<Col style={{ backgroundColor: "blue" }}>Columna 1</Col>
					<Col>
						<Row style={{ backgroundColor: "red" }}>Fila 1</Row>
						<Row style={{ backgroundColor: "yellow" }}>Fila 2</Row>
					</Col>
				</Row>
			</Container>
		</div>*/
